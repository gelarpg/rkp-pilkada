        ...
        <div className="relative flex h-16 items-center justify-between">
          <div className="absolute inset-y-0 left-0 flex items-center sm:hidden">
            ...
            <DisclosureButton className="group relative inline-flex items-center justify-center rounded-md p-2 text-gray-400 hover:bg-gray-700 hover:text-white focus:outline-none focus:ring-2 focus:ring-inset focus:ring-white">
              ...
              <HiMiniBars3 aria-hidden="true" className="block h-6 w-6 group-data-[open]:hidden" />
          ...
          <div className="absolute inset-y-0 right-0 flex items-center pr-2 sm:static sm:inset-auto sm:ml-6 sm:pr-0">
            ...
            <Menu as="div" className="relative ml-3">
              ...
              >
                <MenuItem>
                  <Link href="/account-setting" className=" px-4 py-2 text-sm text-gray-700 data-[focus]:bg-gray-100 flex justify-start items-center gap-2">
                  <PiGear size={20}/>
                    Pengaturan Akun
                  </Link>
                </MenuItem>
                <MenuItem>
                  <Link href="/" className=" px-4 py-2 text-sm text-gray-700 data-[focus]:bg-gray-100 flex justify-start items-center gap-2">
